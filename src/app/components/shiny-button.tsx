...
const ShinyButton = (
    ...
    >
      ...
      <div className="ease-[cubic-bezier(0.19,1,0.22,1)] absolute -left-[75px] -top-[50px] -z-10 h-[165px] w-8 rotate-[35deg] bg-white opacity-40 transition-all duration-600 group-hover:left-[120%]"/>
    </Link>
    )
}
